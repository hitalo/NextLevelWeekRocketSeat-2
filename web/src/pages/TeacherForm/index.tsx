            ...
            <main>
                <form onSubmit={handleCreateClass}>
                    ...
                    <fieldset>
                        ...
                        <Select name="subject" label="Matéria" options={options} value={subject} onChange={(e) => setSubject(e.target.value)} />
                            ...
                            scheduleItems.map((scheduleItem, index) => {
                                return (
                                    <div key={index} className="schedule-item">
                                        <Select name="week_day" label="Dia da semana" options={days} value={scheduleItem.week_day}
